...
export async function POST(request: NextRequest) {
  try {
    ...
    // Create a placeholder for CV URL since we're not handling file upload here
    const applicationData = {
      ...cleanData,
      cvFileUrl: 'placeholder-url', // This will be updated when actual file upload is implemented
      status: 'pending',
    };
