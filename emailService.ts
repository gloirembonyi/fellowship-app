  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #ddd; border-radius: 5px; overflow: hidden;">
      ...
      <div style="background-color: #f8f9fa; padding: 15px; text-align: center; font-size: 12px; color: #666;">
        ...
        <p>For inquiries, please contact our support team at <a href="mailto:${CONTACT_EMAIL}" style="color: #3498db;">${CONTACT_EMAIL}</a></p>
...
export async function sendAcknowledgmentEmail(
  ...
  try {
    const content = `
      ...
      <p>Dear ${name},</p>
      <p>Thank you for submitting your application to the MoH Affiliate Fellowship Program. We have received your application and it is now being processed.</p>
      <p>Your application will be reviewed by our selection committee. You will receive updates on the status of your application via email.</p>
      <p>The review process typically takes 2-4 weeks. During this time, our team may contact you if additional information is needed.</p>
      <p>Thank you for your interest in the MoH Affiliate Fellowship Program.</p>
...
export async function sendApprovalWithDocumentsRequestEmail(
  ...
  try {
    ...
    const content = `
      ...
      <p>Dear ${name},</p>
      <p>Congratulations! Your application for the MoH Affiliate Fellowship Program has been approved.</p>
      <p>To complete your application process, please submit the required additional documents by clicking the button below:</p>
      <p style="text-align: center; margin: 30px 0;">
        <a href="${fullUrl}" style="display: inline-block; background-color: #2ecc71; color: white; padding: 15px 30px; text-decoration: none; border-radius: 4px; font-weight: bold;">Submit Documents</a>
      </p>
    ...
    const mailOptions = {
      from: process.env.EMAIL_FROM,
      to: email,
      subject: 'Your Application Has Been Approved - Documents Required',
